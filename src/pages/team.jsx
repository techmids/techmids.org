...
import viniImage from '@/images/people/vini.jpg'
import ryanImage from '@/images/people/ryan.jpg'
...
const people = [
  {
    name: 'Dr Tom Goodman',
    role: 'Organiser',
    image: tomGoodmanImage,
    linkedinUrl: 'https://www.linkedin.com/in/tagoodman/',
  },
  {
    name: 'James Constantinou (Jimmy Devops)',
    role: 'Organiser',
    image: jimmyImage,
    linkedinUrl: 'https://www.linkedin.com/in/jamesconstantinou/',
  },
  {
    name: 'Vinicius Pinheiro Port',
    role: 'Organiser',
    image: viniImage,
  ...
  },
  {
    ...
    role: 'Organiser',
    image: ryanImage,
    linkedinUrl: 'https://www.linkedin.com/in/ryan-lee-19884b148/',
  },
  {
    name: 'Dave Evans',
    role: 'Organiser',
    image: daveImage,
    linkedinUrl: 'https://www.linkedin.com/in/davedev/',
  },
   {
    name: 'James Seconde',
    role: 'Organiser',
        ...
        {people.map((person) => (
          ...
          >
            <div className="space-y-6 xl:space-y-10">
              <Image
                className="mx-auto aspect-[4/3] overflow-clip rounded-lg object-cover"
                src={person.image}
                alt=""
              />
              <div className="space-y-2 xl:flex xl:items-center xl:justify-between">
                ...
                <ul role="list" className="flex justify-center space-x-5">
                  {person.twitterProfile && (
                    <li>
                      <a
                        href={`https://twitter.com/${person.twitterProfile}`}
